                    ...
                    <ScrollView>
                        {this.state.chats.map((e) => {
                            return <TouchableOpacity onPress={()=>this.chat(e)}>
                                <View style={{ borderWidth: 2, padding: 20 , flexDirection : 'row', backgroundColor : "white"}}>
                                    <Icon name="chat" color="#FF6347" size={25} style={{paddingRight : 10}} />
                                    <Text style={{fontSize : 18}}>{e.actorName}</Text>
